...
export default function AggregatedStatsByCountries() {
  const dispatch = _useDispatch()

  const range: { fromTimestamp: number; toTimestamp: number } | any =
    useSelector(selectRange)

  const aggregatedStatsByCountriesData = useSelector(selectAggregatedStatsByCountriesData)
 
console.log('aggregatedStatsByCountriesData',aggregatedStatsByCountriesData)
  useEffect(() => {
